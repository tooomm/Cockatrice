...
Cockatrice is written in C++11, use of `auto` and other modern constructs is encouraged, even when working on older sections of the codebase that use older standards.
